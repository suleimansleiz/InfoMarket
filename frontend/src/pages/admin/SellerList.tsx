        ...
        <div className="admin-table-header">
          <div className="pill-filters">
            {["all", "retail", "wholesale"].map((type) => (
              ...
              >
                {type === "all" ? "All" : type === "retail" ? "Retail" : "Wholesale"}
              </button>
            ))}
          </div>
          <div>
                ...
                <td>
                  <span
                    className={`status-dot ${
                      item.distribution && item.distribution.toLocaleLowerCase() === "retail" ? "Retail" : "Wholesale"
                    }`}
                  ></span>{" "}
                  {item.distribution}
                </td>
                <td>
                  <Link className="text-decoration-none" to={`/admin/items/${item.sellerId}`}>View</Link>
                </td>
              </tr>
            ))}
          </tbody>
