        ...
        <div className="admin-table-header">
          <div className="pill-filters">
            {["all", "success", "failed"].map((type) => (
              ...
              >
                {type === "all" ? "All" : type === "success" ? "Success" : "Failed"}
              </button>
            ))}
          </div>
          <div>
                ...
                <td>
                  <span
                    className={`status-dot ${
                      item.status.toLocaleLowerCase() === "success" ? "success" : "failure"
                    }`}
                  ></span>{" "}
                  {item.status}
                </td>
                <td>
                  <Link className="text-decoration-none" to={`/admin/items/${item.paymentId}`}>View</Link>
                </td>
              </tr>
            ))}
          </tbody>
