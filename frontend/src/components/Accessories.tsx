...
const Accessories: React.FC = () => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const response = await api.get("/api/infomarket/v1/items/category/Accessories", {});
  ...
  const handleFilterChange = async (type: string) => {
    ...
    try {
      ...
      if (type === "All") {
        response = await api.get("/api/infomarket/v1/items/category/Accessories");
      } else if (type === "Recents") {
        response = await api.get("/api/infomarket/v1/items/category/Accessories/recent");
      } else {
  ...
  return (
    <div className="pages-container">
      ...
      <h1 className="welcome-header text-center">Accessories</h1>
